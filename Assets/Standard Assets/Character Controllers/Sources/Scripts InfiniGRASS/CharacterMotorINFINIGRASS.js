...
class CharacterMotorMovementINFINIGRASS {
...
var movement : CharacterMotorMovementINFINIGRASS = CharacterMotorMovementINFINIGRASS();

enum MovementTransferOnJumpINFINIGRASS {
...
class CharacterMotorJumpingINFINIGRASS {
...
var jumping : CharacterMotorJumpingINFINIGRASS = CharacterMotorJumpingINFINIGRASS();

class CharacterMotorMovingPlatformINFINIGRASS {
	var enabled : boolean = true;
	
	var movementTransfer : MovementTransferOnJumpINFINIGRASS = MovementTransferOnJumpINFINIGRASS.PermaTransfer;
...
var movingPlatform : CharacterMotorMovingPlatformINFINIGRASS = CharacterMotorMovingPlatformINFINIGRASS();

class CharacterMotorSlidingINFINIGRASS {
...
var sliding : CharacterMotorSlidingINFINIGRASS = CharacterMotorSlidingINFINIGRASS();
...
private function UpdateFunction () {
	...
	if (grounded && !IsGroundedTest()) {
		...
		if (movingPlatform.enabled &&
			(movingPlatform.movementTransfer == MovementTransferOnJumpINFINIGRASS.InitTransfer ||
			movingPlatform.movementTransfer == MovementTransferOnJumpINFINIGRASS.PermaTransfer)
		) {
...
private function ApplyInputVelocityChange (velocity : Vector3) {	
	...
	if (movingPlatform.enabled && movingPlatform.movementTransfer == MovementTransferOnJumpINFINIGRASS.PermaTransfer) {
...
private function MoveWithPlatform () : boolean {
	return (
		...
		&& (grounded || movingPlatform.movementTransfer == MovementTransferOnJumpINFINIGRASS.PermaLocked)
